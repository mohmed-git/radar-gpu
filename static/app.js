...
//  👇👇 ضع رابط الدومين الجديد هنا (بدون / في النهاية) 👇👇
// ============================================================
var NEW_DOMAIN = 'https://your-new-domain.com';
// ============================================================
(function () {
  // 1) لا تحوّل إذا لم يُضبط الرابط بعد
  if (!NEW_DOMAIN || /your-new-domain/.test(NEW_DOMAIN)) return
